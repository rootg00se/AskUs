    ...
    return (
        <div
            ...
            className={cn(
                ...
                // Focus state.
                "has-[[data-slot=input-group-control]:focus-visible]:border-secondary has-[[data-slot=input-group-control]:focus-visible]:ring-secondary/50 has-[[data-slot=input-group-control]:focus-visible]:ring-[3px]",
